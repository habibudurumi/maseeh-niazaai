...
const Photo = () => {
  return (
      <div className="w-full h-full relative">
          ...
          <motion.circle cx='253' cy='253' r='250' stroke='#00ff99' strokeWidth='8' strokeLinecap='round' strokeLinejoin='round' initial={{ strokeDasharray: "24 10 0 0" }} animate={{ strokeDasharray:["15 120 25 25", "16 25 92 72", "4 250 22 22"], rotate:[120, 360]}} transition={{duration:20, repeat:Infinity, repeatType:"reverse"}} />
            </motion.svg>
          </motion.div>
    </div>
  )
